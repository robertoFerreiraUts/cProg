...
void main_menu (void)
{
	...
	"2. Decrypt File\n"
	"3. Search File\n"
	"4. Create User\n"	/* Temporary, exits upon completion */
	"5. Exit the program\n"
...
user_t create_user (void)
{
	...
	for (i = 0; i < 1; i++)
	{
		printf("Enter a username that is between 5 to 25 characters long using only letters, underscores and/or numbers, or enter * to go back\n");
	...
	for (i = 0; i < 1; i++)
	{
		printf("Enter a password that is between 8 to 25 characters long, enter * to cancel\n");
	...
	user_t user = {TempName, TempPass, 3, 7};
